...
public partial class Pages_OrderStatus : System.Web.UI.Page
{
    ...
    protected void GridUser_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType != DataControlRowType.Header && e.Row.RowType != DataControlRowType.Pager)
        {
            ...
            if (e.Row.Cells[11].Text == "Delivered")
            {
                e.Row.Cells[11].BackColor = System.Drawing.Color.FromArgb(163, 186, 71);
                e.Row.Cells[11].ForeColor = System.Drawing.Color.Black;
                imglocked.Visible = false;
            }
            if (e.Row.Cells[11].Text == "Rejected")
            {
                e.Row.Cells[11].BackColor = System.Drawing.Color.SandyBrown;
                e.Row.Cells[11].ForeColor = System.Drawing.Color.Black;
                imglocked.Visible = false;
            }
            if (e.Row.Cells[11].Text == "On Hold")
            {
                e.Row.Cells[11].BackColor = System.Drawing.Color.SkyBlue;
                e.Row.Cells[11].ForeColor = System.Drawing.Color.Black;
                imglocked.Visible = false;
            }
            if (e.Row.Cells[11].Text == "Mail Away")
            {
                e.Row.Cells[11].BackColor = System.Drawing.Color.FromArgb(170, 255, 212);
                e.Row.Cells[11].ForeColor = System.Drawing.Color.Black;
                imglocked.Visible = false;
            }
            if (e.Row.Cells[11].Text == "ParcelID")
            {
                e.Row.Cells[11].BackColor = System.Drawing.Color.FromArgb(250, 250, 142);
                e.Row.Cells[11].ForeColor = System.Drawing.Color.Black;
                imglocked.Visible = false;
            }
            if (e.Row.Cells[11].Text == "In Process")
            {
                e.Row.Cells[11].BackColor = System.Drawing.Color.FromArgb(250, 200, 211);
                e.Row.Cells[11].ForeColor = System.Drawing.Color.Black;
                imglocked.Visible = false;
            }
            if (e.Row.Cells[11].Text == "YTS" || e.Row.Cells[11].Text == "Key Completed" || e.Row.Cells[11].Text == "Others" || e.Row.Cells[11].Text == "Order Missing")
            {
                imglocked.Visible = false;
            }
            if ((e.Row.Cells[11].Text == "Key Started") || (e.Row.Cells[11].Text == "QC Started") || (e.Row.Cells[11].Text == "In Process Started") || (e.Row.Cells[11].Text == "Mail Away Started") || (e.Row.Cells[11].Text == "ParcelID Started"))
            {
                e.Row.Cells[11].BackColor = System.Drawing.Color.FromArgb(96, 219, 207);
                e.Row.Cells[11].ForeColor = System.Drawing.Color.Black;
                imglocked.Visible = true;
            }
            if ((e.Row.Cells[11].Text == "Key Started") || (e.Row.Cells[11].Text == "ParcelID Started") || (e.Row.Cells[11].Text == "Mail Away Started") || (e.Row.Cells[11].Text == "In Process Started"))
            {
                string StartTime, EndTime = "";
                string State, County = "";
                StartTime = e.Row.Cells[14].Text;
                EndTime = DateTime.Now.ToString();
                State = e.Row.Cells[7].Text;
                County = e.Row.Cells[8].Text;
                if (StartTime == "&nbsp;") { return; }
