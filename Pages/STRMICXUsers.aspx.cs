...
public partial class Pages_STRMICXUsers : System.Web.UI.Page
{
    ...
    protected void Griduserdetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (e.Row.Cells[12].Text != "" && e.Row.Cells[12].Text != "&nbsp;") e.Row.Cells[0].BackColor = System.Drawing.Color.FromArgb(179, 222, 151);
            else e.Row.Cells[0].BackColor = System.Drawing.Color.FromArgb(250, 200, 211);
        }
    }
    #endregion
