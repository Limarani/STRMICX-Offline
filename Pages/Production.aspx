<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Production.aspx.cs" Inherits="Pages_Production"
...
<body> 
    <form id="form1" runat="server" >
        ...
        <div>
            <table id="MainTable" style="height: 500px; background-color: #f5f5f5;" width="100%"
                class="tblproduction">
                <tr>
                    <td align="center">
                        <asp:Panel ID="PanelOrderallotment" runat="server">
                            <table style="background-color: #f1f1f1" width="1150" cellpadding="5" border="0" cellspacing="10" class="Tblprod">
                                ...
                                <tr>
                                    <td rowspan="12" valign="top" style="width: 212px">
                                        ...
                                        <asp:Panel ID="Panelprocesstime" runat="server" Width="100%" BackColor="#f1f0ef" ScrollBars="Auto">
                                            <table width="100%" border="1" style="border: solid 1px gray;">
                                                <tr style="height:25px;">
                                                    <td class="Lblothers">ProcessTime
                                                    <asp:Label ID="lblordertype" runat="server" Text="" Width="100%" Visible="false"></asp:Label></td>
                                                </tr>
                                                <tr style="height:25px;">
                                                    <td>
                                                        <asp:Label ID="lblprocesstime" runat="server" Text="" Width="100%" Height="25px"></asp:Label>
                                        ...
                                        <asp:Panel ID="Panel2" runat="server" Width="100%" BackColor="#f1f0ef" ScrollBars="Auto">
                                            <asp:GridView ID="GridEntity" runat="server" GridLines="None" CssClass="Gnowrap" AutoGenerateColumns="false">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Entity Type">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtentitytype" runat="server" BorderStyle="None" Text='<%# Eval("EntityTypes")%>' BackColor="FloralWhite" Width="100%" Height="20px"></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
                                    ...
                                    <td class="Lblothers" style="height: 25px;">
                                        Order No</td>
                                    <td>
                                        :</td>
                                    ...
                                    <td style="width: 382px">
                                        ...
                                        <%--<asp:LinkButton ID="Lbldate" runat="server" Text="05-Dec-2012" OnClick="btnstatecomments_Click"></asp:LinkButton>--%>
                                ...
                                <tr>
                                    ...
                                    <td class="Lblothers" align="left">
                                        State Comments
                                        <%--<asp:Button ID="btnstatecomments" runat="server" Text="History" CssClass="MenuFont" OnClick="btnstatecomments_Click" />--%>
                                    </td>
                                    <td align="right" style="width: 382px" colspan="2"><asp:Label ID="lblkeycomplete" runat="server" Text="" Font-Size="18px" Font-Names="Georgia" ForeColor="blueViolet" ></asp:Label></td>
                                </tr>
                                <tr>
                                    <td class="Lblothers">
                                        State with TZ</td>
                                ...
                                <tr>
                                    <td class="Lblothers" style="height: 20px">
                                        Borrower</td>
                                    <td style="height: 20px">
                                        :</td>
                                    <td style="height: 20px; width: 247px;">
                                ...
                                <tr>
                                    ...
                                    <td style="height: 20px">
                                        :</td>
                                    <td style="height: 20px; width: 247px;">
                                        <asp:TextBox ID="txtfollowupdate" runat="server" Height="20px" Width="200px" CssClass="txtuser" OnClick="javascript:NewCal('txtfollowupdate','ddmmmyyyy',true,24)"></asp:TextBox>
                                        <%--<cc1:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender1" runat="server" TargetControlID="txtfollowupdate" WatermarkText="YYYY-MM-DD hh:mm:ss" WatermarkCssClass="txtwatermark" />--%>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="Lblothers">
                                    ...
                                    <td style="width: 247px">
                                     ...
                                     <td colspan="3" rowspan="3" align="left">
                                        <asp:TextBox ID="txtexcomments" runat="server" TextMode="MultiLine"  Height="100px" Width="400px" ReadOnly="True" ></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        <asp:TextBox ID="txtzipcode" runat="server" Height="20px" Width="200px" CssClass="txtuser" MaxLength="5"></asp:TextBox>
                                        <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" FilterType="Numbers" TargetControlID="txtzipcode"></cc1:FilteredTextBoxExtender>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="Lblothers">
                                    ...
                                    <td class="Lblothers">EntityCount:</td>
                                    <td> :</td>
                                       
                                    <td style="width: 247px; height: 62px;">
                                       <asp:TextBox ID="txtentitycount" runat="server" Height="20px" Width="200px" AutoPostBack="true" CssClass="txtuser" OnTextChanged="txtentitycount_TextChanged"></asp:TextBox>
                                       <%--<asp:Button ID="btnaddtxtbox" runat="server" Text="Check Entity" CssClass="MenuFont" OnClick="btnaddtxtbox_Click" />--%>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="Lblothers">
                                    ...
                                    <td>
                                        :</td>
                                    <td style="width: 382px">
                                        <asp:TextBox ID="txtcountyname" runat="server" Height="20px" Width="150px" CssClass="txtuser"></asp:TextBox>
                                        <asp:Button ID="btnsendmail" runat="server" Text="Send Email" CssClass="MenuFont" OnClick="btnsendmail_Click" />
                                    </td>
                                        
                                </tr>
                                <%--<tr>
                                    <td colspan="3" class="Lblothers" style="height: 35px;">
                                        <asp:CheckBox ID="chkparcel" runat="server" Text="Parcel" />
                                        <asp:CheckBox ID="chkimprovements" runat="server" Text="Improvements" />
                                        <asp:CheckBox ID="chkcitytax" runat="server" Text="CityTax" />                                        
                                    </td>                                    
                                </tr>--%>
                                <tr>
                                    <td colspan="7" class="Lblothers" style="height: 100px;">
                                        <asp:Panel ID="PanelCompleted" runat="server" Width="100%" BackColor="#f1f0ef" BorderColor="Gray" BorderStyle="Dashed" BorderWidth="1px">
                                            <table width="100%">
                                                <tr style="height:25px">
                                                    <td colspan="2"><asp:CheckBox ID="chktranstype" runat="server" Text="Transaction Type" /></td>
                                                    <td colspan="2"><asp:CheckBox ID="chkorderdoc" runat="server" Text="Order documents(Legal,Abstract)" /></td>
                                                    <td colspan="2"><asp:CheckBox ID="chkparcelid" runat="server" Text="Parcel ID formats" /></td>
                                                    <td colspan="2"><asp:CheckBox ID="chktaxyear" runat="server" Text="Tax Year" /></td>
                                                </tr>
                                                <tr style="height:25px">
                                                    <td colspan="2"><asp:CheckBox ID="chkamount" runat="server" Text="Amounts" /></td>
                                                    <td colspan="2"><asp:CheckBox ID="chktaxstatus" runat="server" Text="Tax Status" /></td>
                                                    <td colspan="2"><asp:CheckBox ID="chkdates" runat="server" Text="Dates" /></td>
                                                    <td colspan="2"><asp:CheckBox ID="chkbillstatus" runat="server" Text="Tax Bill Status" /></td>
                                                </tr>
                                                <tr style="height:25px;">
                                                    <td colspan="2"><asp:CheckBox ID="chkcomments" runat="server" Text="Comments" /></td>
                                                    <td class="Lblothers"><asp:Label ID="lblmultiple" runat="server" Text="Multiple parcels"></asp:Label></td>
                                                    <td>
                                                        <asp:DropDownList ID="ddlmultiple" CssClass="txtuser" runat="server" Width="85px">
                                                            <asp:ListItem></asp:ListItem>
                                                            <asp:ListItem>YES</asp:ListItem>
                                                            <asp:ListItem>NO</asp:ListItem>
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td class="Lblothers"><asp:Label ID="lblcorrect" runat="server" Text="Correct authorities"></asp:Label></td>
                                                    <td>
                                                        <asp:DropDownList ID="ddlcorrect" CssClass="txtuser" runat="server" Width="85px">
                                                            <asp:ListItem></asp:ListItem>
                                                            <asp:ListItem>YES</asp:ListItem>
                                                            <asp:ListItem>NO</asp:ListItem>
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td class="Lblothers"><asp:Label ID="lblexemption" runat="server" Text="Exemption"></asp:Label></td>
                                                    <td>
                                                        <asp:DropDownList ID="ddlexemption" CssClass="txtuser" runat="server" Width="85px">
                                                            <asp:ListItem></asp:ListItem>
                                                            <asp:ListItem>YES</asp:ListItem>
                                                            <asp:ListItem>NO</asp:ListItem>
                                                ...
                                                <tr style="height:25px">
                                                    <td class="Lblothers" colspan="2"><asp:Label ID="lblfollow" runat="server" Text="Follow the Miscellaneous info notes" ></asp:Label></td>
                                                    <td colspan="2">
                                                        <asp:DropDownList ID="ddlfollow" CssClass="txtuser" runat="server" Width="85px">
                                                            <asp:ListItem></asp:ListItem>
                                                            <asp:ListItem>YES</asp:ListItem>
                                                            <asp:ListItem>NO</asp:ListItem>
                                                        </asp:DropDownList>
                                        ...
                                        <asp:Panel ID="PanelInproHold" runat="server" Width="100%" BackColor="#f1f0ef" BorderColor="Gray" BorderStyle="Dashed" BorderWidth="1px">
                                            <table width="100%">
                                                <tr style="height:25px">
                                                    <td colspan="2"><asp:CheckBox ID="chktranstype1" runat="server" Text="Transaction Type" /></td>
                                                    <td colspan="2"><asp:CheckBox ID="chkorderdoc1" runat="server" Text="Order documents(Legal,Abstract)" /></td>
                                                    <td colspan="2"><asp:CheckBox ID="chkparcelid1" runat="server" Text="Parcel ID formats" /></td>
                                                    <td colspan="2"><asp:CheckBox ID="chkcomments1" runat="server" Text="Comments" /></td>
                                                </tr>
                                                <tr style="height:25px">
                                                    <td class="Lblothers" style="height: 14px"><asp:Label ID="lblmultiple1" runat="server" Text="Multiple parcels"></asp:Label></td>
                                                    ...
                                                    <td class="Lblothers" style="height: 14px"><asp:Label ID="lblcorrect1" runat="server" Text="Correct authorities"></asp:Label></td>
                                                    <td style="height: 14px">
                                                    ...
                                                    <td class="Lblothers" style="height: 14px"><asp:Label ID="lblfollowupdate1" runat="server" Text="Follow up date"></asp:Label></td>
                                                    <td style="height: 14px">
                                                    ...
                                                    <td class="Lblothers" style="height: 14px"><asp:Label ID="lbletadate1" runat="server" Text="ETA Date"></asp:Label></td>
                                                    <td style="height: 14px">
                                                ...
                                                <tr style="height:25px">
                                                    <td class="Lblothers"><asp:Label ID="lblfollow1" runat="server" Text="Follow the Miscellaneous info notes" ></asp:Label></td>
                                                    <td>
                                         ...
                                         <asp:Panel ID="PanelMailaway" runat="server" Width="100%" BackColor="#f1f0ef" BorderColor="Gray" BorderStyle="Dashed" BorderWidth="1px">
                                            <table width="100%">
                                                <tr style="height:25px">
                                                    <td colspan="2"><asp:CheckBox ID="chktranstype2" runat="server" Text="Transaction Type" /></td>
                                                    <td colspan="2"><asp:CheckBox ID="chkorderdoc2" runat="server" Text="Order documents(Legal,Abstract)" /></td>
                                                    <td colspan="2"><asp:CheckBox ID="chkparcelid2" runat="server" Text="Parcel ID formats" /></td>
                                                    <td colspan="2"><asp:CheckBox ID="chkreqtype2" runat="server" Text="Request Type" /></td>
                                                </tr>
                                                <tr style="height:25px">
                                                    <td colspan="2"><asp:CheckBox ID="chkcomments2" runat="server" Text="Comments" /></td>
                                                    <td class="Lblothers"><asp:Label ID="lblmultiple2" runat="server" Text="Multiple parcels"></asp:Label></td>
                                                    <td>
                                                    ...
                                                    <td class="Lblothers"><asp:Label ID="lblcorrect2" runat="server" Text="Correct authorities"></asp:Label></td>
                                                    <td>
                                                    ...
                                                    <td class="Lblothers"><asp:Label ID="lblfollowupdate2" runat="server" Text="Follow up date"></asp:Label></td>
                                                    <td>
                                                ...
                                                <tr style="height:25px">
                                                    <td class="Lblothers"><asp:Label ID="lblfollow2" runat="server" Text="Follow the Miscellaneous info notes" ></asp:Label></td>
                                                    <td>
                                                    ...
                                                    <td class="Lblothers"><asp:Label ID="lbletadate2" runat="server" Text="ETA Date"></asp:Label></td>
                                                    <td>
                                        ...
                                        <asp:Panel ID="PanelParcelID" runat="server" Width="100%" BackColor="#f1f0ef" BorderColor="Gray" BorderStyle="Dashed" BorderWidth="1px">
                                            <table width="100%">
                                                <tr style="height:25px">
                                                    <td><asp:CheckBox ID="chktranstype3" runat="server" Text="Transaction Type" /></td>
                                                    <td><asp:CheckBox ID="chkorderdoc3" runat="server" Text="Order documents(Legal,Abstract)" /></td>
                                                    <td><asp:CheckBox ID="chkcomments3" runat="server" Text="Comments" /></td>
                                                    <td class="Lblothers"><asp:Label ID="lblfollowupdate3" runat="server" Text="Follow up date"></asp:Label></td>
                                                    <td>
                                        ...
                                        <asp:Panel ID="PanelRejected" runat="server" Width="35%" BackColor="#f1f0ef" BorderColor="Gray" BorderStyle="Dashed" BorderWidth="1px">
                                            <table width="100%">
                                                <tr style="height:25px">
                                                    <td><asp:CheckBox ID="chktranstype4" runat="server" Text="Transaction Type" /></td>
                                                    <td><asp:CheckBox ID="chkcomments4" runat="server" Text="Comments" /></td>
                                                </tr>
                                            </table>
                                        </asp:Panel>
                                    </td>
                                 ...
                                 <tr>
                                    <td colspan="7" class="Lblothers">
                                        <asp:Panel ID="PanelExemptions" runat="server" Width="100%" BorderColor="Gray" BorderStyle="Dashed" BorderWidth="1px">
                                            <table width="100%">
                                           <%-- <tr><td>Exemptions</td></tr>--%>
                                                <tr>
                                                    <td colspan="1"><asp:Label ID="lblexm1" runat="server"  Width="180px"></asp:Label><asp:DropDownList ID="ddlexm1" runat="server"  Width="70px" AutoPostBack="true" OnSelectedIndexChanged="ddlexm1_SelectedIndexChanged"></asp:DropDownList></td>
                                                    <td colspan="1"><asp:Label ID="lblexm2" runat="server"  Width="268px"></asp:Label><asp:DropDownList ID="ddlexm2" runat="server"  Width="70px" AutoPostBack="true"  OnSelectedIndexChanged="ddlexm2_SelectedIndexChanged"></asp:DropDownList></td>
                                                    
                                                  
                                               <%-- </tr>
                                                <tr style="height:25px">--%>
                                                <td colspan="1"><asp:Label ID="lblexm3" runat="server"  Width="180px"></asp:Label><asp:DropDownList ID="ddlexm3" runat="server"  Width="70px" AutoPostBack="true"  OnSelectedIndexChanged="ddlexm3_SelectedIndexChanged"></asp:DropDownList></td>
                                                 <td colspan="1"><asp:Label ID="lblexm4" runat="server"  Width="180px"></asp:Label><asp:DropDownList ID="ddlexm4" runat="server"  Width="70px" AutoPostBack="true"  OnSelectedIndexChanged="ddlexm4_SelectedIndexChanged"></asp:DropDownList></td>
                                ...
                                <tr>
                                    <td class="Lblothers">History :</td>
                                    <td colspan="6">
                                        <asp:TextBox ID="txtcmdhistory" runat="server" TextMode="MultiLine" Height="100px" Width="100%" ReadOnly="True"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                            ...
                                            <table style="height: 50px;width:100%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3" align="left">
                                                        <asp:DropDownList ID="ddlcombined" CssClass="txtuser" runat="server" Width="600px" >
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                            </table>
                                ...
                                <tr>
                                    <td class="Lblothers" style="height: 35px; width: 212px;">
                                        Comments</td>
                                    <td>
                                        :</td>
                                    <td colspan="5" align="left">
                                        ...
                                        <asp:CheckBox ID="chkparcelmail" runat="server" Text="Parcel Mail" OnCheckedChanged="chkparcelmail_CheckedChanged" AutoPostBack="true" />
                                ...
                                <tr>
                                    <td colspan="7" align="center" style="height: 35px;">
                                        ...
                                        <asp:Button ID="btngetcomments" runat="server" Text="Get Comments" Width="120px" CssClass="MenuFont" />    
        ...
        <div class="Logout_msgbx" id="ReportPanel" runat="server" align="center">
            <table border="0" width="800px" style="height:550px">
            <tr>
            <td align="center">
                ...
                <tr>
                    <td class="Lblothers"><asp:Label ID="lblcity" runat="server" Text="City" CssClass="Lbldata"></asp:Label></td>                    
                ...
                <tr>
                    <td align="center">
                        <table border="0" cellpadding="3px" cellspacing="4px" width="800px">
                            <tr class="templatemo_menu_wrapper1" style="height: 25px; color: White;" align="center">
                               <td align="center" style="height: 25px">History</td>
                            </tr>
                            <tr>
                                <td><asp:TextBox ID="txtstatecomments" runat="server" TextMode="MultiLine" Height="250px" CssClass="txtuser1" Width="800px" ReadOnly="True"></asp:TextBox></td>
                            </tr>
                            <tr>
                ...
                <tr>
                    <td align="center" valign="top">
                        <table border="0" cellpadding="3px" cellspacing="4px" width="100%">
                            <tr class="templatemo_menu_wrapper1" style="height: 25px; color: White;" align="center">
                               <td align="center" style="height: 25px" colspan="2"> FL Calcuator</td>
                            </tr>
                            <tr>
                                <td style="color:Black;font-weight:bold;font-family:Calibri;">Enter the amount</td>
                                <td align="left">
                                    <asp:TextBox ID="txtflamount" runat="server" CssClass="txtuser1" Width="150px"></asp:TextBox>
                                    <asp:LinkButton ID="Lnkcalculate" runat="server" Text="Calculate" OnClick="Lnkcalculate_Click"></asp:LinkButton>
                                </td>
                            </tr>
                            <tr>
                                <td align="left" colspan="2"><asp:TextBox ID="txtgetcomments" runat="server" TextMode="MultiLine" Height="250px" CssClass="txtuser1" Width="100%" ReadOnly="True"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td align="center" colspan="2"><asp:Button ID="btngetclose" runat="server" Width="150px" Text="Close" CssClass="MenuFont" OnClick="btngetclose_Click" /></td>
                            </tr>
                            <tr>
                                <td colspan="2" align="center"><asp:Label ID="lblFLerror" runat="server" ForeColor="red" Font-Size="Medium"></asp:Label></td>
                            </tr>
                        </table>
                    </td>
                </tr>
        ...
        <div class="Exemptions_msgbox" id="exemptionsmsgbox" runat="server" align="center" visible="false">
           <table border="0" width="400px"  style="height:200px" >
                <tr>
                    <td align="center" valign="top">
                        <table border="0" cellpadding="3px" cellspacing="4px" width="600px">
                            <tr class="templatemo_menu_wrapper1" style="height: 25px; color: White;" align="center">
                               <%--<td align="center" style="height: 50px">Do you want proceed..</td>--%>
                               <td align="center" style="height: 50px"><asp:Label ID="lblexemhead" runat="server" Text=""></asp:Label></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td align="center" ><asp:Button ID="btnExemptionsOk" runat="server" Width="150px" Text="OK" CssClass="MenuFont" OnClick="btnExemptionsOk_Click" /></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <table border="0" width="700px">
                    <tr>
                        <td align="center" valign="top">
                            <table border="0" width="700px">
                                <tr class="templatemo_menu_wrapper1" style="height: 25px; color: White;" align="center">
                                   <td align="center" style="height: 25px" colspan="3">Parcel Inforamtion</td>
                                </tr>
                                <tr>
                                    <td class="Lblothers">No of Parcels </td>
                                    <td class="Lblothers">:</td>
                                    <td><asp:TextBox ID="txtnoofparcels" runat="server" CssClass="txtuser" Width="300px"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="Lblothers">Parcel </td>                      
                                    <td class="Lblothers">:</td>
                                    <td><asp:TextBox ID="txt_parcels" runat="server" CssClass="txtuser" Width="300px"  Height="100px" TextMode="MultiLine"></asp:TextBox></td>   
                                </tr>
                                <tr>
                                    <td class="Lblothers">Parcel No </td>
                                    <td class="Lblothers">:</td>
                                    <td><asp:TextBox ID="tst_parcelno" runat="server" CssClass="txtuser" Width="300px"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td colspan="3" align="center"><asp:Label ID="lblparcelerror" runat="server" ForeColor="red" Font-Size="Large"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td colspan="3" align="center">
                                        <asp:Button ID="btnparcelmail" runat="server" Width="100px" Text="Send Mail" CssClass="MenuFont" OnClick="btnparcelmail_Click" />
                                        <asp:Button ID="btnparcelcancel" runat="server" Width="100px" Text="Cancel" CssClass="MenuFont" OnClick="btnparcelcancel_Click" />
                                    </td>
                                </tr>
                            </table>
                        </td>
            ...
            <table>
                <tr>
                    ...
                    <tr>
                        <tr>
                            <td>
                                <b><span style="font-size: 9pt; color: gray">Service Delivery Team &nbsp;</span></b><b></b><b></b></td>
                            <tr>
                                <tr>
                                    <td>
                                        <u></u><span style="width: 333px; min-height: 11px">
                                            <img src="cid:REDLINE" height="3" width="333"></span><u></u><b><span style="font-size: 11pt;
                                                font-family: Calibri,Calibri; color: gray"><u></u>&nbsp;<u></u></span></b>
                                    </td>
                                </tr>
                                <tr>
                                </tr>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table>
                                                                    <tr>
                                                                        <td>
                                                                            <span style="font-size: 8pt; color: rgb(235,28,35)">(v):</span><span style="font-size: 8pt;
                                                                                color: rgb(78,75,76)">&nbsp;202-470-0648/49</span>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <span style="font-size: 8pt; color: rgb(235,28,35)">(e):</span><span style="font-size: 8pt;
                                                                                color: Blue">&nbsp; <u>tsi@stringinfo.com</u></span>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="height: 21px">
                                                                            <span style="font-size: 8pt; color: rgb(235,28,35)">(w):</span><span style="font-size: 8pt;
                                                                                color: Blue">&nbsp; <u>www.stringinfo.com</u></span>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="height: 21px">
                                                                                ...
                                                                                style="color: rgb(17,85,204)" target="_blank" title="This external link will open in a new window"><b><span
                                                                                    style="font-size: 8pt; color: rgb(15,36,62); text-decoration: none"><img src="cid:LN"
                                                                                        border="0" height="14" width="14"></span></b></a><span style="font-size: 8pt">&nbsp;</span><a
                                                                                            ...
                                                                                            title="This external link will open in a new window"><b><span style="font-size: 8pt;
                                                                                                color: rgb(15,36,62); text-decoration: none"><img src="cid:TWTR" border="0" height="14"
                                                            ...
                                                            <td>
                                                                <table>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <span style="font-size: 8pt; color: rgb(235,28,35)">(e):</span><span style="font-size: 8pt;
                                                                                color: Blue">&nbsp; <u>taxcerts@stringinformation.com</u></span>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="height: 21px">
        ...
        <%--<div id="DivTemplate" runat="server">
            <table border="0">
			    <tr>
				    <td style="color:#808096;" colspan="2"><b>Sincerely,</b></td>
			    </tr>
			    <tr>
				    <td style="color:#808096" colspan="2"><b>Service Delivery Team</b></td>			
			    </tr>
			    <tr>
				    <td colspan="2"><img src="../App_themes/Black/images/2.png" width="350px;"></td>
			    </tr>
			    <tr>
				    <td rowspan="4"><img src="../App_themes/Black/images/1.png"></td>
				    <td style="font-size:12px;"><span style="color:#F11C76;">(v):</span> 202-470-0648 </td>			
			    </tr>
			    <tr>
				    <td style="font-size:12px;"><span style="color:#F11C76;">(e):</span><span style="color:Blue"><u>taxcerts@stringinformation.com</u></span></td>
			    </tr>
			    <tr>
				    <td style="font-size:12px;"><span style="color:#F11C76;">(w):</span><span style="color:Blue"><u> www.stringinfo.com </u></span></td>
			    </tr>
			    <tr>
				    <td style="font-size:12px;">String Information Services &nbsp; 
					    <a href="http://www.linkedin.com/company/50494?trk=tyah&amp;trkInfo=tas:String%20,idx:" title="Linkedin"><img src="../App_themes/Black/images/3.png" border="0"></a>
					    <a href="https://twitter.com/Stringre" title="Twitter"><img src="../App_themes/Black/images/4.jpg" border="0"></a>
				    </td>
			    </tr>
		    </table>
        </div>--%>
