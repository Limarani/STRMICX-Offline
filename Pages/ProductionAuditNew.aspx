<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductionAuditNew.aspx.cs" Inherits="Pages_ProductionAuditNew" Title="PRODUCTION" Theme="Black" %>
...
<body> 
 ...
 <div class="page_dimmer" id="pagedimmer" runat="server"></div>
            ...
            <tr>
                <td>
                    <asp:LinkButton ID="lnkOthers" runat="server" CssClass="Logout" Font-Bold="true"
                        Font-Size="Large" Text="Break" ForeColor="Red" OnClick="lnkOthers_Click"></asp:LinkButton>
                </td>
            </tr>
        </table>       
            ...
            <div id="div_brk_start" runat="server">
                <table width="600px">
                    <tr>
                        ...
                        <td align="center">
                            <asp:DropDownList ID="drp_break" runat="server" Width="150px">
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            <asp:UpdatePanel ID="up_Timer" runat="server" RenderMode="Inline" UpdateMode="Always">
                                ...
                                <ContentTemplate>
                                    <asp:Timer ID="Timer3" runat="server" Interval="1000" OnTick="Timer1_Tick" />
        ...
        <div>
            <table id="MainTable" style="height: 500px; background-color: #f5f5f5;" width="1327px" class="tblproduction">
                <tr>
                    <td align="center">
        ...
        Logout Reason  :</td>
                                <td align="left">
                                    <asp:DropDownList ID="ddllogout" runat="server" Height="20px" Width="200px" 
                                        CssClass="txtuser" OnSelectedIndexChanged="ddllogout_SelectedIndexChanged" 
                                        Visible="False">
                                    </asp:DropDownList>
                                </td>
                            </tr>
